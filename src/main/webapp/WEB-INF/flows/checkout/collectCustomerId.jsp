...
<body>
	...
	<section class="container">
		<form:form method="POST" enctype="multipart/form-data"
			onsubmit="return checkId(this.id);" modelAttribute="order.customer"
			...
			<fieldset>
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnOldCust" class="btn btn-primary"
							value="ID 확인" name="_eventId_customerIdConfirmed" />
						<button id="btnCancel" class="btn btn-default"
							name="_eventId_newCustomer">신규 고객</button>
						<button id="btnCancel" class="btn btn-default"
	...
	<script>
 		function checkId(btn_id) {
			var $btn = document.activeElement;
			var revisitingCustomer = ($btn['id'] === 'btnOldCust');
