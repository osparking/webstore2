...
public class InMemoryCartRepository implements CartRepository {
	...
	public void update(String cartId, CartDto cartDto) {
		...
		for (CartItemDto cartItem : cartItems) {
			Map<String, Object> params = new HashMap<String, Object>();
			String SQL = null;
			if (existingCartItemId(cartItem.getId()) > 0) {
				// if item with <cartId, cartItemId> exists, update it
				...
				SQL = "INSERT INTO CART_ITEM " 
						+ "(ID, PRODUCT_ID, CART_ID, QUANTITY) VALUES "
	...
	private int existingCartItemId(String id) {
		String SQL = "SELECT count(*) "
				+ "FROM hsqldb.cart_item where id = :id";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", id);
		int rowCount = 
				jdbcTempleate.queryForObject(SQL, params, Integer.class);
		return rowCount;
	}
